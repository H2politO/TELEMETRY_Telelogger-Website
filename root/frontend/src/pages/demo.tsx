...
export const Demo = (onLayoutChange) => {
  const components = [
    ...
    //{"nameComponent":"","typeComponent":"4","cmpMinRange":0,"cmpMaxRange":100,"sensorSelected":[{"ID":"2","topicName":"Speed","sensorName":"Speed","minValue":1,"maxValue":100}],"prescaler":1,"deleted":false,"value":0,"w":5,"h":9,"compID":"ddb55488-a191-4eda-82d9-8e1c8755cd4a"},
    {
      ...
      w: 4,
      h: 10,
      compID: "61200ef3-dc36-4f25-ab8b-42a9e0b9d496",
      x: 6,
      y: 0,
    },
    {
      ...
      w: 2,
      h: 10,
      compID: "713b1eb5-3032-44e5-b054-219a022d0e4b",
      x: 4,
      y: 6,
    },
  ];
    ...
    <div>
      ...
      >
        {components.map((comp, index) => (
          <div
            key={comp.compID}
            data-grid={{ x: comp.x, y: comp.y, w: comp.w, h: comp.h }}
          >
            {
              <ComponentEncapsulator
                passedComp={comp as ComponentsPage}
                onDelete={null}
              ></ComponentEncapsulator>
            }
          </div>
