...
export const StrategyPlanner = () => {
  ...
  const [secTimConfigEn, setSecTimConfigEn] = useState(false);
  ...
  const loadData = (file: File) => {
    ...
    fileData.onloadend = (e) => {
      ...
      let isMapComplete =
        ...
        sectorIndex > 0 &&
        speedIndex > 0 &&
        altitudeIndex > 0; //Check if all data is present
      ...
      for (let i = 1; i < fileByLines.length - 1; i++) {
        ...
        if (isMapComplete) {
          stratMap.push({
            ...
            speed: parseFloat(record[speedIndex]),
  ...
  return (
    <div className="mb-auto mx-auto">
      ...
      >
        ...
        {secTimConfigEn && (
          <div key="mapEditSecTim" data-grid={{ x: 0, y: 5, w: 4, h: 10 }}>
            <SectorTimer
              pointIndex={1}
              setSecTimConfigEn={setSecTimConfigEn}
              mapData={stratMap}
