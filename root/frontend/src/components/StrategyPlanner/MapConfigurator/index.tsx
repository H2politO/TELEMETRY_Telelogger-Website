...
const columns: GridColDef[] = [
  ...
  },
  {
    field: "strategy",
    headerName: "Strategy",
    description: "Strategy for point",
    sortable: false,
    editable: true,
    type: "number",
  },
    ...
    <div style={Styles.rootStyle}>
      <div className="dragHandle" id="header" style={Styles.headerStyle}>
        ...
        <Button
          ...
          onClick={() => setBlkConfigEn(true)}
        >
          {" "}
          <AutoAwesomeMotion /> Bulk Edit
        </Button>
        <Button
          style={Styles.secTimButtonStyle}
          onClick={() => setSecTimConfigEn(true)}
        >
          {" "}
          <AutoAwesomeMotion /> Sector Timer
        </Button>
      </div>
      ...
      <div id="main" style={Styles.baseStyle}>
        <DataGrid
          ...
          onProcessRowUpdateError={(err) =>
            console.error("Error modifying row", err)
          }
          initialState={{
            sorting: {
